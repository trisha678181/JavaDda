...
/**
 * Servlet implementation class AddAnniController
 */
@WebServlet("/mypage/couple/addanni")
public class AddAnniController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		boolean bl = coupleService.AddAnni(annititle, annidate, user);
