...
<link rel="stylesheet" type="text/css" href="../../../css/login/business_member.css">
...
// 			$("#inputInfoA").focus()
	...
	$("#businessnum").blur(function() {
		...
		var busno =/^[0-9]{10}$/
		if (!busno.test($(this).val())) {
			$("#alertbusno").css("display", "inline-block");
			$("#businessnum").val("")
// 			$("#businessnum").focus()
			
		} else {
			$("#alertbusno").css("display", "none");
 		...
 		$.ajax({
			type : 'POST'
 			...
 			, success : function(result){
 				...
 				console.log("result.checkbsnum : "+ result.checkbsnum)
				
									
 				if(result.checkBsnum){
 					$("#overlapbusnum").css("display","inline-block")
 					$("#businessnum").val("")

 				}else{
 					$("#overlapbusnum").css("display", "none");
	...
	$("#btnJoin").click(function() {
		...
		else if($("#businessnum").val() == null || $("#businessnum").val() == ''){
			alert("사업자번호는 필수 입력 값 입니다")
		}
		else if($("#inputInfoA").val() == null ||$("#inputInfoA").val() == ''){
...
<body id="general_accout">
	...
	<div class="gen_warp" id="gen_warp">
		...
		<div id="gen_container">
			<form id="gen_account_form" action="/account/business" method="post">
				...
				<div class="join_step_2">
					...
					<div class="box_info_write">
						<dl class="write_input">
							...
							<dd>
								<span class="text_box"> <!-- on : 활성화 --> <input
									type="text" id="inputInfoID" class="input_text valid mustValid"
							...
							<dd>
								<span class="text_box"> <input type="password"
									...
									name="userPass" placeholder="8자 이상,대/소문자, 숫자, 특수문자">
							...
							<dd>
								...
								<input type="password" id="inputInfoPasswordRe"
									class="input_text valid mustValid" name="userPassConfirm"
						...
						<dl class="write_input">
							...
							<dd>
								<div class="select_birthdate">
									...
									</span> <span class="select_month"> 
									<select class="valid" id="inputInfoBirthMonth" name="birthMonth">
											<option selected="1">월</option>
											<option>01</option>
											<option>02</option>
											<option>03</option>
											<option>04</option>
									...
									<input class="valid mustValid" id="inputInfoBirthDay"
							...
							<div>
								<dt class="info_gender">
									...
									<span class="red_bullet">필수항목</span>
								</dt>
								...
								<dd>
									<div class="check_gender" id="gender">
										<span> <!-- selected : 체크됨 --> 
										<input type="radio"
											name="inputInfoGender" id="inputInfoGenderMen" value="m" checked="checked">
											<label for="inputInfoGenderMen"><span class="icon"><b></b></span>남자</label>
										</span> <span> 
										<input type="radio" name="inputInfoGender"
											id="inputInfoGenderWomen" value="f"> 
											<label for="inputInfoGenderWomen"><span class="icon"><b></b></span>여자</label>
										</span> <input type="hidden" id="inputGender" class="valid mustValid"
											name="gender" value="">
									</div>
									<div class="text_alert" style="display: none;">
							...
							<dd>
								<span class="text_box"> 
								<input type="text" id="inputInfoPhone" class="input_text valid mustValid"
							...
							<dt class="info_bsnum">
								<label class="title" for="inputInfoEmail" >사업자 번호</label> <span
									class="red_bullet">필수 항목</span>
							</dt>
							<dd>
								<span class="text_box"> 
								<input type="text" id="businessnum" class="input_text valid mustValid"
									name="bsnum" placeholder="사업자 번호를 입력해 주세요."/> 
								</span>
								<div id="alertbusno" class="text_alert" style="display: none;">
									<p>사업자번호 형식이 올바르지 않습니다</p>
								</div>
								<div id=overlapbusnum class="text_alert" style="display: none;">
									<p>이미 사용중인 사업자 번호 입니다.</p>
								</div>
							...
							<dt class="info_QnA">
								<label class="title" for="inputInfoA">답변</label> <span
									class="red_bullet">필수 항목</span>
							</dt>
							<dd>
								<span class="text_box"> 
								<input type="text" id="inputInfoA" class="input_text valid mustValid"
									name="select_A" placeholder="답변을 입력해 주세요."/> 
								</span>
