		...
		<form method="post" action="/qa/write">
			...
			<tbody>
				<tr>
					...
					<td><h5>${id }</h5><input type="hidden" name="bno" value="2016305043">
					</td>
				</tr>
				<tr>
					<td style="width: 110px;"><h5>글 제목</h5></td>
					<td>
						<input class="form-control" type="text" maxlength="50" name="title" placeholder="글 제목을 입력하세요.">
					</td>
				</tr>
				<tr>
					<td style="width: 110px;"><h5>글 내용</h5></td>
					<td>
						<textarea class="form-control" rows="10" name="qcontent" maxlength="2048" placeholder="글 내용을 입력하세요." id="qcontent"></textarea>
					</td>
				</tr>
			</tbody>
		</table>
