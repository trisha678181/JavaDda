...
<c:import url="../layout/header.jsp" />
	<div class="container">
		<form method="post" action="/admin/noticewrite" id="notice">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<textarea class="form-control" rows="10" id="ntcontent" name="ntcontent" maxlength="2048" placeholder="글 내용을 입력하세요."></textarea>
					</td>
				</tr>			
