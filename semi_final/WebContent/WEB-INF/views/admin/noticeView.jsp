...
$(document).ready(function() {
	...
	$("#btnSearch").click(function() {
		location.href="/admin/noticelist?search="+$("#search").val();
	});
	...
	<div id="adminBox">
		...
		<div class="container" style="margin-bottom: 15px;">
			...
			<table class="table table-bordered table-hover"
				...
				<thead>
					<tr>
						<th colspan="5"><h4 class="board-Title">공지사항</h4></th>
					</tr>
					<tr>
						<th
							style="background-color: #fafafa; color: #000000; width: 70px;"><h5>번호</h5></th>
						<th style="background-color: #fafafa; color: #000000;"><h5>제목</h5></th>
						<th style="background-color: #fafafa; color: #000000; width: 60px;" ><h5>작성자</h5></th>
						<th
							style="background-color: #fafafa; color: #000000;"><h5>작성날짜</h5></th>
						<th
							style="background-color: #fafafa; color: #000000; width: 60px;"><h5>조회수</h5></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${list }" var="notice">
						<tr>
							...
							<td><a href="/admin/noticelistinfo?noticeno=${notice.noticeno }">${notice.title }</a></td>
							<td>관리자</td>
							<td>${notice.ntdate }</td>
							<td>${notice.hit }</td>
						</tr>
						...
						<td colspan="5">
							<div class="btn-toolbar form-inline" role="toolbar"
								...
								<div class="input-group">
									...
									<a href="/admin/noticewrite" class="btn btn-primary pull-right" style="back" type="sumbit">글쓰기</a>
...
<div style="margin-left: 25%;">
		<c:import url="./notice_paging.jsp" />
		</div>
	</div>
	<!-- 회원 리스트 div END -->
